...
const Book = ({ book }) => {
  const { bookId, bookName, author, image, rating, category, tags, price } =
    book;
  ...
  return (
    <Link to={`/books/${bookId}`}>
      <div className="card bg-base-100 p-6 border border-gray-200 rounded-[24px] flex flex-col h-full">
        ...
        <div className="flex justify-between items-center mt-5 text-[#131313B3] font-medium border-b border-dashed pb-5">
          <span>{category}</span>
